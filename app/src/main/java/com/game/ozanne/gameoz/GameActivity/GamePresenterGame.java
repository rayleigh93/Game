...
public class GamePresenterGame implements GameContract.PresenterGame {
    ...
    public GamePresenterGame(@NonNull Repository mRepository, @NonNull GameContract.ViewGame mView, @NonNull EventListener mViewEventListener) {
